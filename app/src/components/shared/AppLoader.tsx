  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-7 bg-bg px-6">
      <div className="relative flex items-center justify-center">
        ...
        {/* Pieces d'or : rendues APRES le badge (donc devant), elles tombent sur
            le portefeuille et sont ABSORBEES (fondu + reduction) au niveau de son
            ouverture. Decalages horizontaux varies pour un flux naturel. */}
        <span aria-hidden className="pointer-events-none absolute inset-x-0 top-0 flex justify-center">
          {[
            ...
            <span
              key={i}
              className="loader-coin absolute flex h-4 w-4 items-center justify-center rounded-full bg-warning text-[9px] font-bold leading-none text-white shadow-sm ring-1 ring-warning/40"
